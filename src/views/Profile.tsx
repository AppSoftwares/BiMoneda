      ...
      {activeSection === 'main' && (
        <>
          <div className="bg-surface-container-low pt-12 pb-10 flex flex-col items-center">
            ...
            <h2 className="mt-6 text-3xl font-black text-primary uppercase tracking-tighter italic">
        ...
        <>
          ...
          <main className="p-6 space-y-8 max-w-md mx-auto">
            <div className="bg-white rounded-lg border border-outline-variant shadow-level-1 p-6 space-y-6">
              ...
              <button onClick={handleUpdateCompany} disabled={loading} className="w-full py-4 bg-primary text-white font-bold rounded-md shadow-md active:scale-95 transition-all text-xs uppercase tracking-widest">
              ...
              <div className="bg-white rounded-lg border-2 border-dashed border-outline-variant/50 p-8 flex flex-col items-center justify-center min-h-[160px]">
                {profile?.signature_url ? (
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <button onClick={() => signatureInputRef.current?.click()} className="px-6 py-2.5 bg-surface-container-low text-secondary text-[10px] font-bold uppercase rounded border border-secondary/30 active:scale-95 transition-all">
                      {t('upload_signature')}
                    </button>
                  </div>
                )}
             ...
             <div className="bg-white rounded-lg border border-outline-variant shadow-level-1 overflow-hidden">
                <div className="p-5 space-y-6">
                   ...
                   <div className="space-y-4">
                      ...
                      <button className="w-full py-3.5 bg-secondary text-white font-bold rounded-md text-xs uppercase tracking-widest mt-2">Actualizar Contraseña</button>
                   </div>
                </div>
             </div>
          ...
          <main className="p-6 space-y-8 max-w-md mx-auto">
             <div className="bg-white rounded-xl shadow-level-1 border border-outline-variant overflow-hidden">
                <div className="p-6 flex items-center justify-between border-b border-outline-variant/20">
                   ...
                   <button onClick={toggleTheme} className={`w-14 h-7 rounded-full p-1 transition-all ${theme === 'dark' ? 'bg-secondary' : 'bg-outline-variant'}`}>
        ...
        <>
          ...
          <main className="p-6 space-y-8 max-w-md mx-auto text-center">
             ...
             <div className="bg-white rounded-3xl shadow-level-2 border border-outline-variant p-8 space-y-6">
                ...
                <button className="w-full py-4 bg-primary text-white font-bold rounded-md shadow-md text-xs uppercase tracking-widest active:scale-95 transition-all">Llamar a Administración</button>
             </div>
          </main>
        </>
      )}
