...
const RegisterClient: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#050c1a] p-6 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] transition-colors">
      <header className="flex items-center justify-between mb-10">
        ...
        <h1 className="text-xl font-black text-primary dark:text-white uppercase tracking-tight">Registrar Cliente</h1>
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-8">
        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-[11px] font-black text-accent-gold uppercase ml-1 tracking-[0.2em]">Nombre Completo / Empresa</label>
            <input
              type="text"
              value={formData.name}
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-black text-accent-gold uppercase ml-1 tracking-[0.2em]">RIF (Tax ID)</label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-black text-accent-gold uppercase ml-1 tracking-[0.2em]">Correo Electrónico</label>
            <input
              type="email"
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-black text-accent-gold uppercase ml-1 tracking-[0.2em]">Teléfono</label>
            <input
              type="tel"
